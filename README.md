...
- [`API-CONTRACT-RULES-AND-GUIDELINES.md`](./docs/API-CONTRACT-RULES-AND-GUIDELINES.md) – Rules and guidelines for designing, structuring and evolving API contracts.
